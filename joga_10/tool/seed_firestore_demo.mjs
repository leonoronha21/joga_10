...
const partidas = [
  {
    ...
    data: {
      ...
      capitaoTime1Uid: ids.admin,
      capitaoTime2Uid: ids.diego,
      modalidade: 'FUTEBOL',
      formato: '5x5',
      ambiente: 'DEMO',
    },
  },
  {
    ...
    data: {
      ...
      capitaoTime1Uid: ids.bruno,
      capitaoTime2Uid: ids.admin,
      modalidade: 'FUTEBOL',
      formato: '7x7',
      ambiente: 'DEMO',
    },
...
const membros = [
  [ids.partida1, ids.admin, 'Admin Local', 'TIME_1', 0, true],
  [ids.partida1, ids.bruno, 'Bruno Silva', 'TIME_1', 0, false],
  [ids.partida1, ids.carla, 'Carla Mendes', 'TIME_1', 0, false],
  [ids.partida1, ids.diego, 'Diego Costa', 'TIME_2', 0, true],
  [ids.partida1, ids.ana, 'Ana Lima', 'TIME_2', 0, false],
  [ids.partida2, ids.admin, 'Admin Local', 'TIME_2', 0, true],
  [ids.partida2, ids.bruno, 'Bruno Silva', 'TIME_1', 0, true],
  [ids.partida2, ids.diego, 'Diego Costa', 'TIME_1', 0, false],
  [ids.partida3, ids.admin, 'Admin Local', 'TIME_1', 2, true],
  [ids.partida3, ids.bruno, 'Bruno Silva', 'TIME_1', 3, false],
  [ids.partida3, ids.carla, 'Carla Mendes', 'TIME_1', 1, false],
  [ids.partida3, ids.diego, 'Diego Costa', 'TIME_2', 2, true],
  [ids.partida3, ids.ana, 'Ana Lima', 'TIME_2', 2, false],
].map(([partidaId, usuarioId, nome, equipe, gols, capitao]) => ({
  path: `partidas/${partidaId}/membros/${usuarioId}`,
  data: { usuarioId, nome, equipe, gols, capitao, ambiente: 'DEMO' },
}));

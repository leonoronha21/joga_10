...
class EstabelecimentoService {
  ...
  ,String telefone,String numero) async {
    ...
    var uri = Uri.parse("http://ec2-18-231-114-59.sa-east-1.compute.amazonaws.com:8080/cadastroEstabelecimento");
   ...
   Future<List<Estabelecimentos>> getAllEstabelecimentos() async {
    var uri = Uri.parse("http://ec2-18-231-114-59.sa-east-1.compute.amazonaws.com:8080/estabelecimentos");
